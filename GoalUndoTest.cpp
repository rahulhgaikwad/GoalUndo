...
TEST(GoalUndoTest, addEmptyGoalCheck)
{	
	GoalUndo g;
	g.addOperation("","Draw Horrizontal line");
	ASSERT_EQ("",g.getOperations());
...
TEST(GoalUndoTest, argUndoRedundantOperationCheck)
{
  GoalUndo g;
  g.addOperation("Draw Triangle","Rotate left 60 degree");
  g.addOperation("Draw Triangle");
  ...
  g.addOperation("Rotate left 60 degree");
  g.undoOperation("Rotate left 60 degree");
  g.undoOperation("Rotate left 60 degree");
  g.undoOperation("Rotate left 60 degree");
  ASSERT_EQ("Draw Triangle",g.getOperations());
}

TEST(GoalUndoTest, undoRedundantOperationCheck)
{
  GoalUndo g;
  g.addOperation("Draw Triangle","Rotate left 60 degree");
  g.addOperation("Draw Triangle");
...
TEST(GoalUndoTest, undoRedundantOperationFailUndoGoalCheck)
{
  GoalUndo g;
  g.addOperation("Draw Triangle","Rotate left 60 degree");
  g.addOperation("Draw Square");
...
TEST(GoalUndoTest, getGoalUndoRedundantOperationFailCheck)
{
  GoalUndo g;
  g.addOperation("Draw Triangle","Rotate left 60 degree");
  g.addOperation("Draw Square","Draw Horrizontal line");
